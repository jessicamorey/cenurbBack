...
$a->addLogger(${($_ = isset($this->services['doctrine.dbal.logger.profiling.seo']) ? $this->services['doctrine.dbal.logger.profiling.seo'] : $this->services['doctrine.dbal.logger.profiling.seo'] = new \Doctrine\DBAL\Logging\DebugStack()) && false ?: '_'});
